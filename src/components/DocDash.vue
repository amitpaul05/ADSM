                        ...
                        <td v-show="is_started" class="py-2 px-4">
                            <button @click="ongoing(patient.serial, index)">
                                <div v-if="is_ongoing[index]" class="flex gap-1">
                                    ...
                                    <div
                                        class='h-2 w-2 bg-green-400 rounded-full animate-bounce [animation-delay:-0.3s]'>
                                    </div>
                                    <div
                                        class='h-2 w-2 bg-green-400 rounded-full animate-bounce [animation-delay:-0.15s]'>
                                    </div>
